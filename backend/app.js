...
var collectionsApiV1Router = require("./routes/api/v1/collections");
var notesApiV1Router = require("./routes/api/v1/notes");
...
app.use("/api/v1", collectionsApiV1Router);
app.use("/api/v1", notesApiV1Router);
